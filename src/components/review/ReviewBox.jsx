    ...
    <div className="mt-3 w-full px-4 md:px-0">
      <div className="border-b border-borderCard-divider w-full px-0">
        <ul className="flex flex-wrap -mb-px space-x-6 font-ubuntu">
          <li>
            <div
              className="inline-block pb-4 text-center cursor-pointer text-paletteText-inactive border-b-2 border-transparent hover:border-gray-300' hover:text-gray-600 hover:border-gray-300"
              aria-current="page"
            >
              Deskripsi Produk
            </div>
          ...
          <li>
            <div className="inline-block pb-4 text-center cursor-pointer text-secondary-70 rounded-t-lg border-b-4 border-secondary-70 active font-bold">
              Review
            </div>
          </li>
        </ul>
